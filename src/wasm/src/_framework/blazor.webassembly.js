!(function () {
  ...
  const S = new Map(),
    ...
    A = new Map();
  function I(e, t, n) {
    return R(e, t.eventHandlerId, () =>
      N(e).invokeMethodAsync("DispatchEventAsync", t, n)
    );
  }
  function N(e) {
    const t = S.get(e);
  ...
  e.attachReviver((e, t) =>
    t &&
    "object" == typeof t &&
    Object.prototype.hasOwnProperty.call(t, Q) &&
    "string" == typeof t[Q]
      ? (function (e) {
          const t = `[${Z(e)}]`;
  ...
  class ue {
          ...
          Ne() &&
            (function (e, t) {
              ...
              if (
                ...
                Ee(t) && (e.preventDefault(), xe(t, !0, !1));
              }
            })(e);
        });
    }
    ...
    updateComponent(e, t, n, r) {
      ...
      ae.delete(o) && (H(o), o instanceof Comment && (o.textContent = "!"));
  ...
  let Fe = async function (e) {
      ...
      if (t?.hasLocationChangingEventListeners) {
        const n = e.state?._index ?? 0,
          ...
          o = n - De,
          i = location.href;
        if ((await Be(-o), !(await je(i, r, !1, t)))) return;
        await Be(o);
      }
      await Je(!0);
    },
  ...
  const Oe = {
    ...
    endLocationChanging: function (e, t) {
      Le && e === _e && (Le(t), (Le = null));
    },
    navigateTo: function (e, t) {
      Me(e, t, !0);
    },
    refresh: function (e) {
      !e && Ce() ? Ae(location.href, !0) : location.reload();
    },
  ...
  async function xe(e, t, n, r = void 0, o = !1) {
    ...
    const i = $e();
    (o || !i?.hasLocationChangingEventListeners || (await je(e, r, t, i))) &&
      ((ve = !0), Pe(e, n, r), await Je(t));
  }
  function Pe(e, t, n = void 0) {
    t
      ? history.replaceState({ userState: n, _index: De }, "", e)
      : (De++, history.pushState({ userState: n, _index: De }, "", e));
  }
  function Be(e) {
  ...
  function je(e, t, n, r) {
    return new Promise((o) => {
      He(), _e++, (Le = o), r.locationChanging(_e, e, t, n);
    });
  }
  async function Je(e, t) {
    const n = t ?? location.href;
    await Promise.all(
      Array.from(Te, async ([t, r]) => {
        var o;
        (o = t),
  ...
  async function ze(e) {
    Fe && We() && (await Fe(e)), (De = history.state?._index ?? 0);
  }
  function $e() {
    const e = Re();
    if (void 0 !== e) return Te.get(e);
  }
  function We() {
    return Ne() || !Ce();
  }
  const Ue = {
    ...
    Ke = {
      init: function (e, t, n, r = 50) {
        ...
        const a = d(t),
          c = d(n),
          { observersByDotNetObjectId: l, id: u } = Ye(e);
        function d(e) {
      ...
      dispose: function (e) {
        const { observersByDotNetObjectId: t, id: n } = Ye(e),
          r = t[n];
        r &&
  ...
  function Ye(e) {
    const t = e._callDispatcher,
      n = e._id;
    return (t[Ve] ??= {}), { observersByDotNetObjectId: t[Ve], id: n };
  }
  const qe = {
  ...
  const Qe = new Set(),
    et = {
      ...
      disableNavigationPrompt: function (e) {
        Qe.delete(e),
          0 === Qe.size && window.removeEventListener("beforeunload", tt);
      },
    };
  function tt(e) {
  ...
  window.Blazor = rt;
  const ot = navigator,
    it = ot.userAgentData && ot.userAgentData.brands,
    st =
      it && it.length > 0
        ? it.some(
            (e) =>
        ...
        : window.chrome,
    at = ot.userAgentData?.platform ?? navigator.platform;
  function ct(e) {
    return (
      0 !== e.debugLevel && (st || navigator.userAgent.includes("Firefox"))
    );
  }
  let lt = !1;
  function ut() {
          ...
          (async function (e, n) {
            ...
            if (void 0 !== o) {
              if (e.singleRuntime) {
                ...
                let u = n;
                e.webRendererId === dt.Server && c && (u = c),
                  e.webRendererId === dt.WebAssembly && s && (u = s);
                let d = r;
                return (
                  e.webRendererId === dt.Server && l && (d = l),
                  e.webRendererId === dt.WebAssembly && a && (d = a),
                  i(e, u, d, t)
                );
              }
  ...
  const vt = {
    load: function (e, t) {
      return (async function (e, t) {
        const { dotnet: n } = await (async function (e) {
            ...
            const n = import.meta.resolve(t)//new URL(t, document.baseURI).toString();
              ...
              r = {
                ...
                onConfigLoaded: async (n) => {
                  n.environmentVariables || (n.environmentVariables = {}),
                    ...
                    (rt._internal.getApplicationEnvironment = () =>
                      n.applicationEnvironment),
                    t?.(n),
                    (bt = await (async function (e, t) {
                      if (e.initializers)
                        return (
                          await Promise.all(
                        ...
                        );
                      {
                        const n = [e, t.resources?.extensions ?? {}],
                          r = new mt(!0, void 0, void 0, dt.WebAssembly),
                          o = Object.keys(
    ...
    start: function () {
      return (async function () {
        ...
        (pt = n),
          (function (e) {
            const t = at.match(/^Mac/i) ? "Cmd" : "Alt";
            ct(e) &&
              console.info(
          ...
          (rt.runtime = gt),
          (rt._internal.dotNetCriticalError = Ct),
          t("blazor-internal", { Blazor: { _internal: rt._internal } });
        const i = await gt.getAssemblyExports(
          "Microsoft.AspNetCore.Components.WebAssembly"
        );
        return (
          Object.assign(rt._internal, {
            dotNetExports: {
              ...i.Microsoft.AspNetCore.Components.WebAssembly.Services
                .DefaultWebAssemblyJSRuntime,
            },
          }),
          (ht = e.attachDispatcher({
            beginInvokeDotNetFromJS: (e, t, n, r, o) => {
              ...
              rt._internal.dotNetExports.BeginInvokeDotNet(
                e ? e.toString() : null,
                i,
                n,
                o
            ...
            invokeDotNetFromJS: (e, t, n, r) => (
              At(),
              rt._internal.dotNetExports.InvokeDotNet(e || null, t, n ?? 0, r)
            ),
          })),
          { invokeLibraryInitializers: o }
        );
    ...
    callEntryPoint: async function () {
      try {
        await gt.runMain(gt.getConfig().mainAssemblyName, []);
      } catch (e) {
        console.error(e), ut();
      }
    },
    ...
    readInt16Field: function (e, t) {
      return gt.getHeapI16(e + (t || 0));
    },
    readInt32Field: function (e, t) {
      return gt.getHeapI32(e + (t || 0));
    },
    readUint64Field: function (e, t) {
      return gt.getHeapU52(e + (t || 0));
    },
    readObjectField: function (e, t) {
      return gt.getHeapU32(e + (t || 0));
    },
    readStringField: function (e, t, n) {
      const r = gt.getHeapU32(e + (t || 0));
      if (0 === r) return null;
      if (n) {
        const e = pt.monoObjectAsBoolOrNullUnsafe(r);
        if ("boolean" == typeof e) return e ? "" : null;
      }
      return pt.monoStringToStringUnsafe(r);
    },
    readStructField: function (e, t) {
      return e + (t || 0);
    },
    beginHeapLock: function () {
      return At(), (yt = It.create()), yt;
    },
    invokeWhenHeapUnlocked: function (e) {
      yt ? yt.enqueuePostReleaseAction(e) : e();
    },
  };
  function wt(e, t) {
    const n = (e / t) * 100;
  ...
  const Et = ["DEBUGGING ENABLED"],
    St = (e) => Et.indexOf(e) < 0 && console.log(e),
    Ct = (e) => {
      console.error(e || "(null)"), ut();
    };
  function At() {
    if (yt) throw new Error("Assertion failed - heap is currently locked");
  }
  class It {
    ...
    release() {
      ...
      for (
        pt.mono_wasm_gc_unlock(), yt = null;
        this.postReleaseActions?.length;

      )
        this.postReleaseActions.shift()(), At();
    }
    static create() {
      return pt.mono_wasm_gc_lock(), new It();
    }
  }
  class Nt {
    constructor(e) {
      (this.batchAddress = e),
        (this.arrayRangeReader = Rt),
        (this.arrayBuilderSegmentReader = kt),
        (this.diffReader = Dt),
        (this.editReader = _t),
        (this.frameReader = Tt);
    }
    ...
    referenceFrames() {
      return t.readStructField(this.batchAddress, Rt.structLength);
    }
    disposedComponentIds() {
      return t.readStructField(this.batchAddress, 2 * Rt.structLength);
    }
    disposedEventHandlerIds() {
      return t.readStructField(this.batchAddress, 3 * Rt.structLength);
    }
    updatedComponentsEntry(e, t) {
      return Ft(e, t, Dt.structLength);
    }
    referenceFramesEntry(e, t) {
      return Ft(e, t, Tt.structLength);
    }
  ...
  const Rt = {
    ...
    Dt = {
      structLength: 4 + kt.structLength,
      componentId: (e) => t.readInt32Field(e, 0),
      edits: (e) => t.readStructField(e, 4),
      editsEntry: (e, t) => Ft(e, t, _t.structLength),
    },
    _t = {
      structLength: 20,
          ...
          c = (function (e, t, n) {
            ...
            if (r) {
              for (; n.next() && n.currentElement; ) {
                ...
                const t = Pt.exec(e.textContent),
                  o = t && t[1];
                if (o) return Kt(o, r), e;
              }
              throw new Error(
        ...
        switch (s.type) {
          case "webassembly":
            return (
              ...
              (i = c),
              Ut((r = s)),
              { ...r, uniqueId: $t++, start: o, end: i }
            );
          case "server":
            return (function (e, t, n) {
              return Wt(e), { ...e, uniqueId: $t++, start: t, end: n };
            })(s, n, c);
          case "auto":
            return (function (e, t, n) {
              return Wt(e), Ut(e), { ...e, uniqueId: $t++, start: t, end: n };
            })(s, n, c);
        }
      } catch (e) {
        throw new Error(
  ...
  function Qt(e) {
    ...
    return (Jt = new Promise(en.bind(null, e))), Jt;
  }
  async function en(e, n, r) {
    ...
    !(function (e) {
      ...
      R = (e, n, r) => {
        ((e, t, n) => {
          ...
          r?.eventDelegator.getHandler(t) && vt.invokeWhenHeapUnlocked(n);
        })(e, n, () => t(e, n, r));
      };
    })(),
      (rt._internal.applyHotReload = (e, t, n, r, o) => {
        ht.invokeDotNetStaticMethod(
          "Microsoft.AspNetCore.Components.WebAssembly",
          "ApplyHotReloadDelta",
          e,
          t,
      ...
      (rt._internal.getApplyUpdateCapabilities = () =>
        ht.invokeDotNetStaticMethod(
          "Microsoft.AspNetCore.Components.WebAssembly",
          "GetApplyUpdateCapabilities"
        )),
      (rt._internal.invokeJSJson = nn),
      (rt._internal.endInvokeDotNetFromJS = rn),
      (rt._internal.receiveWebAssemblyDotNetDataStream = on),
      (rt._internal.receiveByteArray = sn);
    const i = ((t = vt), t);
    (rt.platform = i),
      (rt._internal.renderBatch = (e, t) => {
        const n = vt.beginHeapLock();
        try {
          !(function (e, t) {
            const n = he[e];
            if (!n)
            ...
            ve && ((ve = !1), window.scrollTo && window.scrollTo(0, 0));
          })(e, new Nt(t));
        } finally {
          n.release();
        }
      }),
      rt._internal.navigationManager.listenForNavigationEvents(
        dt.WebAssembly,
        async (e, t, n) => {
          await ht.invokeDotNetStaticMethodAsync(
            "Microsoft.AspNetCore.Components.WebAssembly",
        ...
        async (e, t, n, r) => {
          const o = await ht.invokeDotNetStaticMethodAsync(
            "Microsoft.AspNetCore.Components.WebAssembly",
    ...
    (rt._internal.registeredComponents = {
      ...
      (rt._internal.getPersistedState = () => Ot(document) || ""),
      (rt._internal.getInitialComponentsUpdate = () => Yt),
      (rt._internal.updateRootComponents = (e) =>
        rt._internal.dotNetExports?.UpdateRootComponentsCore(e)),
    ...
    i.callEntryPoint(), bt.invokeAfterStartedCallbacks(rt), n();
  }
  function tn() {
    return (
      (jt ??= (async () => {
  ...
  function nn(e, t, n, r, o) {
    return 0 !== o
      ? (ht.beginInvokeJSFromDotNet(o, e, r, n, t), null)
      : ht.invokeJSFromDotNet(e, r, n, t);
  }
  function rn(e, t, n) {
    ht.endInvokeDotNetFromJS(e, t, n);
  }
  function on(e, t, n, r) {
    !(function (e, t, n, r, o) {
      let i = nt.get(t);
  ...
  let ln = !1;
  async function un(e) {
    if (ln) throw new Error("Blazor has already started.");
    (ln = !0), Zt(Promise.resolve(e || {})), cn.create(rt);
    const t = xt(document, "webassembly"),
      n = new an(t);
    await Qt(n);
  }
  (rt.start = un),
